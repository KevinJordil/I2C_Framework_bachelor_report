...
Le connecteur sélectionné doit comporter quatre broches, comprenant l'alimentation du circuit imprimé (3,3V et GND) ainsi que les broches pour l'\gls{i2c} (SDA et SCL).
