...
La conception du circuit imprimé a été confiée à l'\gls{iai} de la \gls{heigvd}, afin de maintenir une conception interne offrant une flexibilité pour les modifications ultérieures.
...
\todo{Expliquer le choix fait sur les resistance pull up sur le circuit imprimé}
